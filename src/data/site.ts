...
export const members: MemberGroup[] = [
  ...
  {
    title: [
      { type: "link", label: "ASUS Linux", href: "https://asus-linux.org/" },
    ],
    statement: [
      {
        type: "text",
    ...
    title: [
      {
        type: "link",
        label: "ShadowBlip",
        href: "https://github.com/ShadowBlip/",
      },
    ],
    statement: [
      {
  ...
  {
    title: [
      { type: "link", label: "Fyra Labs", href: "https://fyralabs.com/" },
    ],
    statement: [
      {
        type: "text",
...
export const partners: MemberGroup = {
  ...
  statement: [
    ...
    { type: "text", text: ", and " },
    {
      type: "link",
      label: "winesapOS",
      href: "https://github.com/winesapOS/winesapOS",
      strong: true,
    },
...
export const downloads: DownloadLink[] = [
  {
    title: "Bazzite",
    statement:
      "A custom image built upon Fedora for gaming on PCs and handhelds.",
  ...
  },
  {
    title: "ChimeraOS",
    statement:
      "An operating system that provides an out-of-the-box couch gaming experience.",
  ...
  },
  {
    title: "winesapOS",
    statement:
      "A portable Linux OS for gaming that can be installed on a flash drive.",
